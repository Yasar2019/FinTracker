    ...
    <div className='min-h-screen bg-slate-100 text-slate-900 transition-colors dark:bg-slate-950 dark:text-slate-100'>
      <div className='mx-auto flex min-h-screen w-full max-w-screen-2xl flex-col lg:flex-row'>
        ...
        <main className='flex-1 p-4 md:p-6'>
          <Header accounts={data.accounts} selectedAccount={selectedAccount} onSelectAccount={setSelectedAccount} darkMode={darkMode} onToggleTheme={() => setDarkMode((previous) => !previous)} />
